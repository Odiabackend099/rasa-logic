...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE tablename = 'call_logs' AND policyname = 'Service role full access'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'leads' AND policyname = 'Service role full access'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'conversations' AND policyname = 'Service role full access'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'handoffs' AND policyname = 'Service role full access'
    ) THEN
